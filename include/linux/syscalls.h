...
asmlinkage long sys_ioprio_override(int pid);
asmlinkage long sys_bdev_set_bytes(const char __user *dev_name, int enable,
				 unsigned int bfq_high_bytes,
				 unsigned int bfq_low_bytes);
asmlinkage long sys_bdev_get_bytes(const char __user *dev_name);
