...
struct request_queue {
	...
	// 一个原子量统计IO总大小
	atomic_long_t		io_bytes;
	// 一个threshold
	atomic_long_t		io_bytes_threshold;
	/* number of burst requests currently queued or in flight */
	atomic_t		burst_ios;
	bool			io_bytes_enable;
	unsigned int		io_high_bytes;
	unsigned int		io_low_bytes;
